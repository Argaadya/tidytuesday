...
df_map %>% 
  ...
  labs(fill = "Number of Choclate Variant",
       ...
       subtitle = "The history of chocolate began in Mesoamerica, with fermented beverages made from chocolate date back to 450 BC (<i>Wikipedia</i>). 
       <br> Nowadays, data from <b> flavorsofcacao.com </b> reveals that most of chocolate bars come from South America, espescially <b>Venezuela, Peru, and Ecuador</b>. 
